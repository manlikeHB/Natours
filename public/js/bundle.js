...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFubGlrZWhiIiwiYSI6ImNsOWNsbWF0NjA2dXozd28zaXdveTEzeXEifQ.PzBl7E1xsy--RO0G068EiQ';
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (updatedUser.data.status === 'sucess') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " saved successfully!!!"));
            }
            _context.next = 11;
            break;
          case 8:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var stripe = Stripe('pk_test_51LzGrtFAZSQ8NbRZFyuRdZiWi4qiwWBaVlme6ZkT7fV6hzHg34AVTMMVWFk0OixOa2OHCAyZmCy4DxD9aXjuXqRc00p3JwBuE1');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            result = _context.sent;
            if (result.data.status === 'sucess') {
              (0, _alerts.showAlert)('success', 'Sign Up sucessful!!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var userDataPassword = document.querySelector('.form-user-password');
...
if (userDataPassword) {
  document.querySelector('.form-user-password').addEventListener('submit', /*#__PURE__*/function () {
